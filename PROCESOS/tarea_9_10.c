...
Ante la llegada de cualquier señal, se escribe en un fichero denominado reg.dat tanto 
el orden como la señal correspondiente.
El fichero, que debe tener obligatoriamente ese nombre, si no existe, se crea, y si existe, 
se borra su contenido.
El programa corre indefinidamente hasta que llega SIGINT, en cuyo caso, además de escribir 
en disco el orden y la señal, cierra el fichero y termina la ejecución.
