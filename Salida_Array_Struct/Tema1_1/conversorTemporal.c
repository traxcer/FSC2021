...
Varios ejemplos de ejecución de este programa serían:
              ...
              >./conversorTemporal
               ...
               9127145 segundos equivalen a [ 15] semanas, 0 dias, 15:19:05
en donde las partes que aparecen en rojo, son las que escribe el programa y el resto, 
lo que escribe el usuario. Obsérvese que en el formato de salida:
El número de meses aparece entre corchetes y precedido por un espacio en blanco. 
Ejemplos: [ 3], [ 12], [ 22],
Las horas, minutos y segundos aparecen en el formato hh:mm:ss. 
Ejemplos: 23:04:12, 04:59:59, 12:10:25, etc. (El número de horas nunca será mayor de 23 
y el número de minutos y segundos nunca será mayor de 59).
El número de días nunca podrá ser mayor que 6 (dado que 7 días constituyen 1 semana)
Para el correcto funcionamiento de las pruebas automáticas, se han de utilizar las 
funciones printf() y scanf() para imprimir por pantalla y leer de teclado, respectivamente.
*/
#include <stdio.h>

int main(){
    int segundos;
    scanf("Introduce un número de segundos: %d", segundos);
